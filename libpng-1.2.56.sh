...
# Variables
REPO_URL="https://downloads.sourceforge.net/project/libpng/libpng12/older-releases/1.2.56/libpng-1.2.56.tar.gz"
REPO_DIR="libpng-1.2.56"
...
[ ! -e libpng-1.2.56.tar.gz ] && wget $REPO_URL
...
CC=wllvm CFLAGS="-O0 -g -fno-omit-frame-pointer -gline-tables-only -fsanitize=address -fsanitize-address-use-after-scope -fsanitize-coverage=trace-pc-guard,trace-cmp,trace-gep,trace-div" ../configure --disable-shared
make -j32

wllvm -g -O0 -fno-omit-frame-pointer -gline-tables-only -fsanitize=address -fsanitize-address-use-after-scope -fsanitize-coverage=trace-pc-guard,trace-cmp,trace-gep,trace-div ../../fuzzobj.c .libs/libpng12.a -I ~/aflgo/examples/fuzzer-test-suite/libpng-1.2.56/libpng-1.2.56 -lz -lm -DPNG_SKIP_SETJMP_CHECK -DPNG_INTERNAL -o fuzzobj
...
# CC=clang CXX=clang++ CFLAGS="-O0 -g -fno-omit-frame-pointer -gline-tables-only -fsanitize=address -fsanitize-address-use-after-scope -fsanitize-coverage=trace-pc-guard,trace-cmp,trace-gep,trace-div" CXXFLAGS="-O0 -g -fno-omit-frame-pointer -gline-tables-only -fsanitize=address -fsanitize-address-use-after-scope -fsanitize-coverage=trace-pc-guard,trace-cmp,trace-gep,trace-div" ../configure --disable-shared
# clang++ -g -O0 -fno-omit-frame-pointer -gline-tables-only -fsanitize=address -fsanitize-address-use-after-scope -fsanitize-coverage=trace-pc-guard,trace-cmp,trace-gep,trace-div -std=c++11 ../../target.cc .libs/libpng12.a libFuzzingEngine-wllvm.a -I ~/aflgo/examples/fuzzer-test-suite/libpng-1.2.56/libpng-1.2.56 -I ~/aflgo/examples/fuzzer-test-suite/libpng-1.2.56/ -lz -lstdc++ -lm -o fuzzobj-structure-aware -include ../../png_mutator.h -DPNG_MUTATOR_DEFINE_LIBFUZZER_CUSTOM_MUTATOR -DSTANDALONE_TARGET=0