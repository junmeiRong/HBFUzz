...
echo 'elf.c:9510' > $TMP_DIR/target.txt
# echo 'tekhex.c:338' > $TMP_DIR/target.txt
# echo 'srec.c:432' > $TMP_DIR/target.txt
# echo 'elf.c:10153' > $TMP_DIR/target.txt
# echo 'hash.c:550' > $TMP_DIR/target.txt
# echo 'elfcode.h:555' > $TMP_DIR/target.txt
# echo 'bfd.c:1109' > $TMP_DIR/target.txt
