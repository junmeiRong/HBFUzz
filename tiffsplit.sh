...
# echo 'tif_ojpeg.c:1279' > $TMP_DIR/target.txt
# echo 'tif_dirread.c:1978' > $TMP_DIR/target.txt
# echo 'tif_strip.c:154' > $TMP_DIR/target.txt
# echo 'tif_dirwrite.c:794' > $TMP_DIR/target.txt
# echo 'tif_tile.c:154' > $TMP_DIR/target.txt
# echo 'tif_next.c:139' > $TMP_DIR/target.txt
echo 'tif_dir.c:567' > $TMP_DIR/target.txt
