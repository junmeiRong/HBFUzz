...
# echo 'jv_dtoa.c:3123' > $TMP_DIR/target.txt
# echo 'jv_dtoa.c:2005' > $TMP_DIR/target.txt
# echo 'jv_unicode.c:42' > $TMP_DIR/target.txt
# echo 'jv_dtoa.c:3045' > $TMP_DIR/target.txt
# echo 'jv_dtoa.c:2517' > $TMP_DIR/target.txt
# echo 'jv_dtoa.c:4064' > $TMP_DIR/target.txt
# echo 'jv_dtoa.c:3149' > $TMP_DIR/target.txt
# echo 'jv_dtoa.c:2601' > $TMP_DIR/target.txt
# echo 'jv_dtoa.c:2807' > $TMP_DIR/target.txt
# echo 'jv_parse.c:440' > $TMP_DIR/target.txt
echo 'jv_print.c:182' > $TMP_DIR/target.txt
