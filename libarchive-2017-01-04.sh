...
REPO_DIR="libarchive-2017-01-04"
CHECKOUT_COMMIT="51d7afd3644fdad725dd8faa7606b864fd125f88"
...
CC=wllvm CXX=wllvm++ CFLAGS="-O0 -g" CXXFLAGS="-O0 -g" ../configure --disable-shared --without-nettle
make -j32
...
wllvm++ -g -O0 -std=c++11 -fsanitize=address ../../libarchive_fuzzer.cc -I ../libarchive .libs/libarchive.a libFuzzingEngine-wllvm.a -lz -lbz2 -lxml2 -lcrypto -lssl -llzma -llzo2 -o fuzzobj
