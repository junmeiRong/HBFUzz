...
# echo 'layer3.c:1118' > $TMP_DIR/target.txt
# echo 'interface.c:690' > $TMP_DIR/target.txt
# echo 'mp3gain.c:605' > $TMP_DIR/target.txt
# echo 'interface.c:663' > $TMP_DIR/target.txt
echo 'apetag.c:341' > $TMP_DIR/target.txt
